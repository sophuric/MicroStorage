...
import static me.sophur.sophstorage.Blocks.*;
...
public class SophStorage implements ModInitializer {
    ...
    public void onInitialize() {
        ...
        CreativeModeTab.Builder creativeTabBuilder = FabricItemGroup.builder().title(Component.translatable("itemGroup.sophStorage"));
